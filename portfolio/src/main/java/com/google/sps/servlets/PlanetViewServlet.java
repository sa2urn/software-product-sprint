...
public class PlanetViewServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    response.getWriter().print("<body background=\"/images/space.jpg\" style=\"font-family: Verdana, sans-serif;color:white; text-align:center; background-color: rgb(0, 0, 0, 0.6); background-blend-mode: multiply;\">");
